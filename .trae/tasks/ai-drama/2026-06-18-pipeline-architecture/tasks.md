...
- [ ] T9.3: Verify AC01 (输入小说 → 输出 .mp4 + .srt)
- [ ] T9.4: Verify AC02 (角色一致性 SSIM > 0.85)
- [ ] T9.5: Verify AC03 (分镜 JSON v2.0 Schema 校验)
- [ ] T9.6: Verify AC04 (断点续传)
- [ ] T9.7: Verify AC05 (单镜头失败重试)
- [ ] T9.8: Verify AC06 (工具后端替换)
- [ ] T9.9: Verify AC07 (视频时长偏差 < 5%)
- [ ] T9.10: Verify AC08 (字幕一致性)
- [ ] T9.11: Verify AC09 (TTS-first 音画同步 < 200ms)
- [ ] T9.12: Verify AC10 (长文本章节事件图谱)
- [ ] T9.13: Verify AC11 (跨项目资产复用)
- [ ] T9.14: Verify selected mature path was implemented and no rejected shortcut was introduced.
- [ ] T9.15: Run automated verification and record command output in verification-report.md.
- [ ] T9.16: Map implementation result to Acceptance Criteria in verification-report.md.
